...
import com.devsimone.appointify.StudentDash.Adapters.BookingAdapter
import com.devsimone.appointify.databinding.FragmentBookingsBinding
                            ...
                            if (snapshot1.exists()) {
                                ...
                                if (app.appOwnId == Paper.book().read<String>("userAdmin")) {
                                    ...
                                    binding.rcBook.adapter =
                                        context?.let { BookingAdapter(bookList, context = it) }
                                } else {
                                    //Hello
                                }
